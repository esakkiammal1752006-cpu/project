...
$total_tasks = $conn->query("SELECT COUNT(*) as total FROM reports WHERE assigned_to = '$user_id'")->fetch_assoc()['total'];
$completed_tasks = $conn->query("SELECT COUNT(*) as total FROM reports WHERE assigned_to = '$user_id' AND status='completed'")->fetch_assoc()['total'];
$pending_tasks = $conn->query("SELECT COUNT(*) as total FROM reports WHERE assigned_to = '$user_id' AND status='pending'")->fetch_assoc()['total'];
$in_progress_tasks = $conn->query("SELECT COUNT(*) as total FROM reports WHERE assigned_to = '$user_id' AND status='in_progress'")->fetch_assoc()['total'];
...
<head>
    ...
    <title>Swachh Bharat - Worker Profile</title>
    ...
    <style>
        ...
        /* Welcome Banner - Green theme (matching worker dashboard) */
        .welcome-banner {
        ...
        /* Profile Info - Matching worker dashboard cards */
        .profile-info {
            display: flex;
            align-items: center;
            gap: 25px;
        ...
        /* Forms - Matching worker dashboard */
        .form-section {
            background: white;
            border-radius: 10px;
            padding: 20px;
        ...
        /* Buttons - Matching worker dashboard */
        .btn-success {
        ...
        /* Messages - Matching worker dashboard */
        .alert {
            border-radius: 10px;
            border: none;
            padding: 15px;
        ...
        /* Info Cards - Matching worker dashboard */
        .info-card {
            background: #f8f9fa;
            border: 2px solid #e9ecef;
            border-radius: 8px;
...
<body>
    <!-- Sidebar - EXACT SAME AS WORKER DASHBOARD -->
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="worker_profile.php" class="nav-link active">
    ...
    <div class="main-content">
        ...
        <div class="back-link">
            <a href="worker.php"><i class="fas fa-arrow-left"></i> Back to Dashboard</a>
        </div>
        ...
        <div class="top-bar">
            ...
            <div class="worker-info">
                <div>
                    ...
                    <div class="text-muted">Municipal Worker</div>
                </div>
        ...
        <div class="profile-container">
            ...
            <div class="profile-body">
                <!-- Profile Info Section - Matching worker dashboard cards -->
                <div class="profile-info">
                    ...
                    <div class="profile-details">
                        ...
                        <div class="profile-contact">
                            ...
                            <span><i class="fas fa-phone"></i> <?php echo htmlspecialchars($user_data['phone']); ?></span>
                            <?php if(!empty($user_data['address'])): ?>
                                <span><i class="fas fa-map-marker-alt"></i> <?php echo htmlspecialchars($user_data['address']); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
